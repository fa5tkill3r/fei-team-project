  ...
  <div class='drawer lg:drawer-open'>
    ...
    <div class='drawer-content flex flex-col'>
      ...
      >
        ...
        <div class='flex-1'>
          <ul class='menu menu-horizontal m-auto gap-2'>
            <li><a>Link</a></li>
            <li><a>Link</a></li>
            <li><a>Link</a></li>
          </ul>
      ...
      >
        ...
        >
          ...
          <ul class="collapse-content space-y-2">
            <li>
              <router-link to='/team/create' class='btn btn-sm btn-outline btn-primary'>
                <PlusIcon class="w-5 h-5" />
              </router-link>
            </li>

            <li v-for='team in teamStore.teams'>
              <button class="btn btn-sm btn-ghost"
                      :class="{'btn-active': team.id === teamStore.team.id}"
